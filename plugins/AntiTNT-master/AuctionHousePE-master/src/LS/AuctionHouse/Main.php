...
namespace LS\AuctionHouse;

use LS\AuctionHouse\Task;
use LS\AuctionHouse\CooldownTask;
...
class Main extends PluginBase implements Listener{
    ...
    public function onEnable() {
        ...
        $this->config = new Config($this->getDataFolder(). "config.yml", Config::YAML, array(
            "cooldown-seconds" => 5,
            "has-cooldown-message" => "§l§6●§a Hãy Chờ Một Chút §6●"
        ));
		...
		$this->auctionSettings = (new Config($this->getDataFolder() . "AuctionSettings.yml", Config::YAML, array(
			"AuctionName" => "          §l§b Đấu§e Gía",
			"ItemDisplay" => "§l§aVật Phẩm: §b{itemName} \n\n§r§l§aNgười Bán: §b{seller}\n§r§l§aGía: §b{price}§r\n\n§r§l§aHết Hạn: §b{expiration}",
			"MyAuction" => "§l§aĐấu Gía Của Bạn\n§r§eBạn Đang Có §b{myauction}§c/{auctionlimit} §aĐấu Gía",
			"Bin" => "§l§aThùng Rác\n§r§eNhấn Vào Đây Để Xem Và thu Thập Tất Cả Của Bạn\nCác Vật Phẩm Hết Hạn Tại Đấu Gía",
			"LeftArrow" => "§l§e<< Trang Trước",
			"Refresh" => "§l§dLàm Mới\n§r§eBấm Đây Để Làm Mới Danh Sách!",
			"RightArrow" => "§l§eTrang Sau >>",
			"HowToSell" => "§l§6Làm Sao Để Bán\n§r§eCầm Vật Phẩm Trên Tay Và Bấm §a/ah sell <giá>",
			"Guide" => "§l§aHướng Dẫn\n§r§l§aĐấu Gía§e Là Một Nơi\nBạn Có Thể Đấu Gía Vật Phẩm!",
			"AuctionBinName" => "          §l§bVật Phẩm Hết Hạn",
			"BackToAuction" => "§l§aQuay Lại Đấu Gía",
			"ClaimAll" => "§l§bNhận Tất Cả"
		)))->getAll();
		$this->message = (new Config($this->getDataFolder() . "Message.yml", Config::YAML, array(
			"Prefix" => "§l§6[§bSky§aBlock(Bin)§6] ",
			"HoldItem" => "§cHãy cầm đồ trong tay§r",
			"SurvivalOnly" => "§cHãy chuyển sang sống sót",
			"DontMove" => "§cXin đừng di chuyển trong khi mở Đấu giá",
			"AddAuctionSuccess" => "§eBạn thêm thành công §b{itemName} §ex§b{itemCount} §echo §b{price} §etrên §aAuction§r",
			"ReachAuctionLimit" => "§cBạn đã đạt đến giới hạn đấu giá§r",
			"InvalidPriceRange" => "§cChỉ có §b{minimumPrice} §cđến §b{maximumPrice} §cgiá được cho phép§r",
			"InvalidPriceValue" => "§cVui lòng đặt một số hợp lệ§r",
			"InvalidItem" => "§cMục không được phép",
			"ReceivedMoney" => "§eBạn đã nhận được §b{money} §etừ §ađấu giá§r",
			"PurchaseSuccess" => "§eBạn đã mua §b{itemName} §ex§b{itemCount} §echo §b{price}§r",
			"NotEnoughMoney" => "§cBạn không có đủ tiền§r",
			"FailedToOpen" => "§cKhông mở được. Vui lòng thử lại sau",
			"MoveUp" => "§cKhông mở được. Hãy di chuyển 5 khối lên",
			"NoDupe" => "§cTrục trặc Dupe không được phép!",
			"NotAvailable" => "§cMục không có sẵn. Cố gắng làm mới§r"
		)))->getAll();
