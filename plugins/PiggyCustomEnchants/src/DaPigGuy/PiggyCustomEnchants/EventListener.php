...
class EventListener implements Listener
{
                ...
                foreach ($entity->getArmorInventory()->getContents() as $slot => $armor) {
                    ...
                    if ($enchantment !== null) {
                        if ($event->getFinalDamage() >= $entity->getHealth()) {
                            ...
                            $entity->sendTip(TextFormat::GREEN . "§lBạn Đã Được Tái Sinh.");
                    ...
                    if ($enchantment !== null) {
                        if ($event->getFinalDamage() >= $entity->getHealth()) { //Compatibility for plugins that auto respawn players on death
                            for ($i = (($enchantment->getLevel() > 5) ? 5 : $enchantment->getLevel()); $i >= 0; $i--) {
                        ...
                        if ($entity->getHealth() - $event->getFinalDamage() <= 4) {
                            if (!isset($this->plugin->endershiftcd[$entity->getLowerCaseName()]) || time() > $this->plugin->endershiftcd[$entity->getLowerCaseName()]) {
                                ...
                                if (!$entity->hasEffect(Effect::SPEED)) {
                                    $effect = new EffectInstance(Effect::getEffect(Effect::SPEED), 200 * $enchantment->getLevel(), $enchantment->getLevel(), false);
                                    $entity->addEffect($effect);
                                }
                                if (!$entity->hasEffect(Effect::ABSORPTION)) {
                                    $effect = new EffectInstance(Effect::getEffect(Effect::ABSORPTION), 200 * $enchantment->getLevel(), $enchantment->getLevel(), false);
                                    $entity->addEffect($effect);
                                }
                                $entity->sendMessage("§l§6[§bSky§aBlock(Bin)§6] §aBạn cảm thấy một luồng năng lượng đến từ áo giáp của bạn!");
                            }
                        }
                    }
                    ...
                    if ($enchantment !== null) {
                        if ($entity->getHealth() - $event->getFinalDamage() <= 4) {
                            if ((!isset($this->plugin->berserkercd[$entity->getLowerCaseName()]) || time() > $this->plugin->berserkercd[$entity->getLowerCaseName()]) && $entity->hasEffect(Effect::STRENGTH) !== true) {
                                ...
                                $entity->addEffect($effect);
                                $entity->sendMessage("§l§6[§bSky§aBlock(Bin)§6] §aBloodloss của bạn làm cho bạn mạnh mẽ hơn!");
                            }
                        }
                    }
                }
                    ...
                    foreach ($entity->getArmorInventory()->getContents() as $slot => $armor) {
                        ...
                        if ($damager instanceof Living) {
                            ...
                            if ($enchantment !== null && $damager->hasEffect(Effect::SLOWNESS) !== true) {
                                $effect = new EffectInstance(Effect::getEffect(Effect::SLOWNESS), 20 * $enchantment->getLevel(), $enchantment->getLevel(), false);
                                $damager->addEffect($effect);
                            }
                        ...
                        if ($enchantment !== null) {
                            if ((!isset($this->plugin->cloakingcd[$entity->getLowerCaseName()]) || time() > $this->plugin->cloakingcd[$entity->getLowerCaseName()]) && $entity->hasEffect(Effect::INVISIBILITY)) {
                                ...
                                $entity->addEffect($effect);
                                $entity->sendMessage(TextFormat::DARK_GRAY . "§l§6[§bSky§aBlock(Bin)§6] §aBạn đã trở lên tàng hình!");
                            }
                        }
                ...
                if ($enchantment !== null) {
                    if (isset($this->plugin->flying[$entity->getLowerCaseName()]) && $this->plugin->flying[$entity->getLowerCaseName()] > time()) {
                        if ($entity->isOnGround()) {
                            ...
                            $entity->sendTip(TextFormat::RED . "§l§cJetpack Đã Tắt");
                        } else {
                            $entity->sendTip(TextFormat::RED . "§l§eNó Là Không An Toàn Dể Vô Hiệu Qúa.");
                        }
                    } else {
                        if (!in_array($event->getPlayer()->getLevel()->getName(), $this->plugin->jetpackDisabled)) {
                            if (!isset($this->plugin->jetpackcd[$entity->getLowerCaseName()]) || $this->plugin->jetpackcd[$entity->getLowerCaseName()] <= time()) {
                                ...
                                $entity->sendTip(TextFormat::GREEN . "§l§aJetpack Đã Bật, Hãy Nhấn Nút Ngồi Lần Nữa Để Tắt.");
                                if (isset($this->plugin->flyremaining[$entity->getLowerCaseName()])) {
                                    unset($this->plugin->flyremaining[$entity->getLowerCaseName()]);
                                }
                            }
                        } else {
                            $entity->sendTip(TextFormat::RED . "§l§cJetpacks Bị Vô Hiệu Qúa Tại Đây.");
                        }
                    }
                }
            }
        ...
        if ($event instanceof EntityDamageEvent) {
            if ($entity instanceof Living) {
                ...
                if ($enchantment !== null && $entity->hasEffect(Effect::BLINDNESS) !== true) {
                    $effect = new EffectInstance(Effect::getEffect(Effect::BLINDNESS), 20 * $enchantment->getLevel(), 0, false);
                    $entity->addEffect($effect);
                }
            ...
            if ($enchantment !== null) {
                $damage = 2 + (($enchantment->getLevel() > 5) ? 5 : $enchantment->getLevel() / 10);
            ...
            if ($enchantment !== null) {
                if ($entity instanceof Player && isset($this->plugin->hallucination[$entity->getLowerCaseName()]) !== true) {
            ...
            if ($enchantment !== null) {
                $chance = 10 * (($enchantment->getLevel() > 5) ? 5 : $enchantment->getLevel());
                $random = mt_rand(0, 100);
                if ($random <= $chance) {
    ...
    public function checkBowEnchants(Player $damager, Entity $entity, EntityEvent $event)
    {
        if ($event instanceof EntityDamageByChildEntityEvent) {
            ...
            if ($enchantment !== null and $entity instanceof Living) {
                ...
                if (!$entity->hasEffect(Effect::BLINDNESS)) {
                    $effect = new EffectInstance(Effect::getEffect(Effect::BLINDNESS), 20 * $enchantment->getLevel(), $enchantment->getLevel(), false);
                    $entity->addEffect($effect);
                }
                if (!$entity->hasEffect(Effect::WEAKNESS)) {
                    $effect = new EffectInstance(Effect::getEffect(Effect::WEAKNESS), 40 * $enchantment->getLevel(), $enchantment->getLevel(), false);
                    $entity->addEffect($effect);
                }
            }
            ...
            if ($enchantment !== null) {
                ...
                if ($entity instanceof Player) {
                    ...
                    $entity->sendMessage(TextFormat::DARK_PURPLE . "§l§6[§bSky§aBlock(Bin)§6] §aBạn đã được đổi chỗ với§c " . $damager->getDisplayName());
                }
                $damager->sendMessage(TextFormat::DARK_PURPLE . "§l§6[§bSky§aBlock(Bin)§6] §aBạn đã được đổi chỗ với§c " . $name);
            }
        ...
        if ($event instanceof EntityShootBowEvent) {
            ...
            if ($enchantment !== null) {
                $amount = 1 + 2 * (($enchantment->getLevel() > 50) ? 50 : $enchantment->getLevel());
        ...
        if ($event instanceof ProjectileHitBlockEvent && $entity instanceof Projectile) {
            ...
            if ($enchantment !== null) {
                for ($i = 0; $i <= (($enchantment->getLevel() > 5) ? 5 : $enchantment->getLevel()); $i++) {
