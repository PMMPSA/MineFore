...
class Main extends PluginBase
{
    ...
    public $enchants = [
        ...
        CustomEnchantsIds::ANTIKNOCKBACK => ["AntiKnockback", "Armor", "Damage", "Rare", 1, "Reduces knockback by 25% per armor piece"],
        ...
        CustomEnchantsIds::BOUNTYHUNTER => ["BountyHunter", "Bow", "Damage", "Uncommon", 5, "Collect bounties (items) when hitting enemies."],
        ...
        CustomEnchantsIds::OBSIDIANSHIELD => ["ObsidianShield", "Armor", "Equip", "Common", 5, "Gives fire resistance while worn"],
        ...
        CustomEnchantsIds::WITHERSKULL => ["WitherSkull", "Bow", "Shoot", "Mythic", 1, "Shoots Wither Skull"],
