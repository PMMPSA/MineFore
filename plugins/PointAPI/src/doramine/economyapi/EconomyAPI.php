...
use doramine\economyapi\provider\Provider;
use doramine\economyapi\provider\YamlProvider;
use doramine\economyapi\provider\MySQLProvider;
use doramine\economyapi\event\money\SetMoneyEvent;
use doramine\economyapi\event\money\ReduceMoneyEvent;
use doramine\economyapi\event\money\AddMoneyEvent;
use doramine\economyapi\event\money\MoneyChangedEvent;
use doramine\economyapi\event\account\CreateAccountEvent;
use doramine\economyapi\task\SaveTask;
...
class EconomyAPI extends PluginBase implements Listener{
	...
	private function registerCommands(){
		...
		$commands = [
			"mypoint" => "\\doramine\\economyapi\\command\\MyMoneyCommand",
			"toppoint" => "\\doramine\\economyapi\\command\\TopMoneyCommand",
			"setpoint" => "\\doramine\\economyapi\\command\\SetMoneyCommand",
			"seepoint" => "\\doramine\\economyapi\\command\\SeeMoneyCommand",
			"givepoint" => "\\doramine\\economyapi\\command\\GiveMoneyCommand",
			"takepoint" => "\\doramine\\economyapi\\command\\TakeMoneyCommand",
			"payp" => "\\doramine\\economyapi\\command\\PayCommand",
			"setlangp" => "\\doramine\\economyapi\\command\\SetLangCommand",
			"mystatusp" => "\\doramine\\economyapi\\command\\MyStatusCommand"
		];
