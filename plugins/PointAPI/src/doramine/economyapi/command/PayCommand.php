...
namespace doramine\economyapi\command;
...
use doramine\economyapi\event\money\PayMoneyEvent;
...
class PayCommand extends Command{
	...
	public function execute(CommandSender $sender, string $label, array $params): bool{
		...
		/*if($sender->isOp()){
			$sender->sendMessage("§l§6[§bSky§aBlock(Bin)§6]§c Bạn là op không được dùng lệnh này!");
			return true;
		}*/
