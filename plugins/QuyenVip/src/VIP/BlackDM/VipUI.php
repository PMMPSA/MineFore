...
if ($cmd->getName() == "quyenrank"){
  ...
  $form->addLabel("§l§a●§c Nhận Được Nhiều Đảo");
  ...
  $form->addLabel("§l§a●§c Nhận Được Nhiều Đảo");
  $form->addLabel("§l§b♦§e Quyền Lợi §aRich§cKid:");
  $form->addLabel("§l§a●§b Fly [/fly]");
  $form->addLabel("§l§a●§b Teleport [/tp]");
  $form->addLabel("§l§a●§b Feed [/feed]");
  $form->addLabel("§l§a●§b Heal [/heal]");
  ...
  $form->addLabel("§l§b♦§e Quyền Lợi §cMa§bst§aer:");
  $form->addLabel("§l§a●§b Fly [/fly]");
  $form->addLabel("§l§a●§b Teleport [/tp]");
  $form->addLabel("§l§a●§b Feed [/feed]");
  $form->addLabel("§l§a●§b Heal [/heal]");
  $form->addLabel("§l§a●§b Size [/size]");
  $form->addLabel("§l§a●§c Nhận Được Kit §cMa§bst§aer");
  $form->addLabel("§l§a●§c Nhận Được Nhiều Đảo");
  $form->addLabel("§l§a●§c Mở Được 4 Kho Đồ [/khodo]");
  $form->addLabel("§l§a●§d Sáng Tạo [/sangtao]");
  $form->addLabel("§l§a●§d Sinh Tồn [/sinhton]");
  $form->addLabel("§l§a●§a Lưu Ý Khi Sáng Tạo Sẽ Mất Đồ!");
  $form->sendToPlayer($s); 
}
return true;
}
