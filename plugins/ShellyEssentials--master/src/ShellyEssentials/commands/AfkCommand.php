...
class AfkCommand extends BaseCommand{
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args) : bool{
		...
		if(!in_array($sender->getName(), self::$afk)){
			...
			$sender->sendMessage("§l§6[§bSky§aBlock(Bin)§6] "   . TextFormat::GREEN . "You have turned on afk mode");
			...
			$sender->sendMessage("§l§6[§bSky§aBlock(Bin)§6] "   . TextFormat::RED . "You have turned off afk mode");
