...
class WildCommand extends BaseCommand{
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args) : bool{
		...
		$sender->sendMessage("§l§6[§bSky§aBlock(Bin)§6] "   . TextFormat::GREEN . "You have been teleported to coords " . TextFormat::AQUA . "X: $x | Y: 128 | Z: $z" . TextFormat::GREEN . " in the wild!");
