...
class XYZCommand extends BaseCommand{
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args) : bool{
		...
		if(!in_array($sender->getName(), $this->xyz)){
			...
			$sender->sendMessage("§l§6[§bSky§aBlock(Bin)§6] "   . TextFormat::GREEN . "You have turned on your coords");
			...
			$sender->dataPacket($pk);
			$sender->sendMessage("§l§6[§bSky§aBlock(Bin)§6] "   . TextFormat::RED . "You have turned off your coords");
		}
		return true;
	}
}