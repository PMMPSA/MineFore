...
class ClaimSubCommand extends SubCommand
{
    ...
    public function execute(CommandSender $sender, array $args) {
        ...
        if ($this->getPlugin()->getProvider()->savePlot($plot)) {
			...
			$player->getInventory()->addItem(Item::get(295, 0, 7));
			$player->sendMessage("§l§6[bMine§aFore§6]§a Nhận đảo thành công, sử dụng§b nước §avà§6 hàng rào§a để tạo máy đào khoáng sản");
