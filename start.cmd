...
if exist bin\php\php_wxwidgets.dll (
	...
	start "" bin\mintty.exe -o Columns=85 -o Rows=50 -o AllowBlinking=0 -o FontQuality=3 -o Font="Consolas" -o FontHeight=9 -o CursorType=0 -o CursorBlinks=1 -h never -t "PocketMine-MP" -i bin/pocketmine.ico -w normal %PHP_BINARY% %POCKETMINE_FILE% --enable-ansi %*
